 ...
 */
package com.whp.android.ui.slidingmenu;
...
public class SlidingMenuLayout extends ViewGroup {
	...
	protected SlidingMenuLayoutListener mListener;
	...
	public void onFinishInflate() {
		...
		if (!isInEditMode ()) {
			...
			int idSideBar = getResources ().getIdentifier ("animation_layout_sidebar", "id",
					getContext ().getPackageName ());
			mSidebar = findViewById (idSideBar);

			int idContent = getResources ().getIdentifier ("animation_layout_content", "id",
					getContext ().getPackageName ());
			mContent = findViewById (idContent);
			/*
			 * mSidebar = findViewById(R.id.animation_layout_sidebar); mContent
			 * = findViewById(R.id.animation_layout_content);
			 */
			if (mSidebar == null) {
	...
	public void setListener(SlidingMenuLayoutListener l) {
		mListener = l;
	}
