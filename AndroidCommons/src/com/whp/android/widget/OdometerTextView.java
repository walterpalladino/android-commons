...
public class OdometerTextView extends TextView {
	...
	private void animateDigit(Canvas canvas, Paint textPaint, int digit, float textSize, String digitAboveString, String digitBelowString) {
    	...
    	textPaint.getTextBounds(digitBelowString, 0, 1, textBounds);
		 ...
		 canvas.drawText(digitBelowString, canvas.getWidth() - digitWidth * (digit + 1), textSize + canvas.getHeight() - offsetY, textPaint);
